...
(() => {
  ...
  var renderComponent = async () => {
    try {
      const response = await fetch(
        "https://jsonplaceholder.typicode.com/posts/1"
      );
      const data = await response.json();
      const html = import_server.default.renderToString(/* @__PURE__ */ (0, import_jsx_runtime2.jsx)(HelloWorld1, { data }));
      return html;
    } catch (error) {
      console.error("Error fetching data:", error);
      return import_server.default.renderToString(/* @__PURE__ */ (0, import_jsx_runtime2.jsx)(HelloWorld1, { data: null }));
    }
  };
