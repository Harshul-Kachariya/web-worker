...
(() => {
  ...
  var renderComponent = async () => {
    try {
      ...
      const html = import_server.default.renderToString(/* @__PURE__ */ (0, import_jsx_runtime2.jsx)(HelloWorld2, { data }));
      return html;
    } catch (error) {
      console.error("Error fetching data:", error);
      return import_server.default.renderToString(/* @__PURE__ */ (0, import_jsx_runtime2.jsx)(HelloWorld2, { data: null }));
    }
  };
